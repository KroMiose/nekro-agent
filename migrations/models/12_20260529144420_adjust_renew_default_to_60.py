...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "adapter_instance" ALTER COLUMN "renew_before_minutes" SET DEFAULT 60;"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "adapter_instance" ALTER COLUMN "renew_before_minutes" SET DEFAULT 30;"""
...
MODELS_STATE = (
    ...
    "chTojYCeh1iR+G+E6145oKd2kTR8NQCRLKmNpQFTC17oT0/LskFlgp3U8R1sKyWAFDllhD"
