...
<>内为可选项 {}为必填项 会话ID格式为 group_群号 uesr_QQ号
| 指令 | 权限 | 需要@ | 范围 | 说明 |
|:-----:|:----:|:----:|:----:|:----:|
| /reset <会话ID> | 主人 | 否 | 私聊/群聊 | 不添加会话ID默认清除当前会话聊天记录 |
| /config_show | 主人 | 否 | 私聊/群聊 | 查看当前配置支持动态修改的配置项 |
| /config_set | 主人 | 否 | 私聊/群聊 | 修改配置项 |
| /inspect <会话ID> | 主人 | 否 | 私聊/群聊 | 查询指定会话的基本信息 |
| /exec {代码} | 主人 | 否 | 私聊/群聊 | 执行沙盒代码 |
| /code_log <idx?>| 主人 | 否 | 私聊/群聊 | 查询当前会话的执行记录 |
| /system <消息> | 主人 | 否 | 私聊/群聊 | 发送系统消息 |
| /na_on <会话ID> | 主人 | 否 | 私聊/群聊 | 开启指定会话的聊天功能 |
| /na_off <会话ID> | 主人 | 否 | 私聊/群聊 | 关闭指定会话的聊天功能 |
