...
class DBPluginData(Model):
    ...
    target_chat_key = fields.CharField(max_length=256, index=True, description="目标聊天频道唯一标识")
    target_user_id = fields.CharField(max_length=256, index=True, description="目标用户ID")
