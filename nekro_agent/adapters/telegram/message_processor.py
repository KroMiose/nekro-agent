...
from nekro_agent.schemas.chat_message import ChatMessageSegment, ChatMessageSegmentType, ChatMessageSegmentImage, ChatMessageSegmentFile
...
class MessageProcessor:
    ...
    async def _handle_message(self, message: Message, context: ContextTypes.DEFAULT_TYPE = None) -> None:
        ...
        platform_channel = PlatformChannel(
            ...
            channel_name=message.chat.title or message.chat.first_name or str(message.chat.id),
        ...
        platform_message = PlatformMessage(
            ...
            sender_name=message.from_user.first_name or message.from_user.username or str(message.from_user.id),
            content_text=self._extract_text_content(content_segments),
            content_data=content_segments,
            sender_nickname=message.from_user.first_name or message.from_user.username or str(message.from_user.id),
